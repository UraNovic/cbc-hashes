...
var decodeAddress = require('cbc-address-codec').decodeAddress;
var binary = require('cbc-binary-codec');
...
function computeTrustlineHash(address1, address2, currency) {
  ...
  var prefix = ledgerSpaceHex('cbcState');
